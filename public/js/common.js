...
function outputPostsWithReplies(results, container) {
    ...
    if(results.replyTo) {
        if(results.replyTo !== undefined && results.replyTo._id !== undefined) {
            ...
            container.append("This thread seems to be removed by the user");
            return;
        }        
    } 
...
function createUserHtml(userData, showFollowButton) {
    ...
    var followButton = "";
    var tagline = "";
    if(userData.graduationBatch) {
        tagline = "Class of " + userData.graduationBatch;
    }
    else {
        tagline = "Faculty"
    }
    ...
    return `<div class='user'>
                ...
                <div class='userDetailsContainer'>
                    <div class='header'>
                        ...
                        <div class='graduationBatch'>${tagline}</div>
                    </div>
                </div>
                ${followButton}
...
function getNotificationText(notification) {
    ...
    if(notification.notificationType == "retweet") {
        ...
        text = `${userFromName} is following you`;
    }    
...
function showMessagePopup(data) {
    ...
    setTimeout(()=> element.hide().fadeOut(400), 5000).slideDown("fast");
}
